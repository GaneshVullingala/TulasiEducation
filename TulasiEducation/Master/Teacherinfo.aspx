<%@ Page Title="" Language="C#" MasterPageFile="~/Master/HomeMaster.Master" AutoEventWireup="true" CodeBehind="Teacherinfo.aspx.cs" Inherits="TulasiEducation.Master.Teacherinfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Teacher Info</h6>
                <h1 class="mb-5">Teacher Information</h1>
            </div>
        <div class="row">
            <div class="col-md-4">
                <asp:Label ID="Label1" runat="server" Text="Search Teacher" Font-Names="Arial" Font-Size="19"></asp:Label>
            </div>
            <div class="col-md-4">
                ...
                <asp:GridView ID="grv_list" runat="server" Width="100%" DataKeyNames="Genid" AutoGenerateColumns="false" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" ForeColor="Black" GridLines="Horizontal" ShowFooter="false" CellSpacing="0" CellPadding="10" Font-Size="Small" AllowPaging="true" PageSize="10" PagerSettings-Position="Bottom" OnPageIndexChanging="grv_list_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Subject">
                            <ItemTemplate>
                                <asp:Label ID="lblqualification" runat="server" Text='<%# Eval("Subject") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="View/Edit">
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkView" runat="server" Text="View" NavigateUrl='<%# Eval("GenID", "AddTeacher.aspx?GenID={0}") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
