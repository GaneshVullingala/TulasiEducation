<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TeacherMaster.Master" AutoEventWireup="true" CodeBehind="TeacherChat.aspx.cs" Inherits="TulasiEducation.Master.TeacherChat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h1 class="mb-5">Clarify Student Doubts here</h1>
    </div>
    <asp:GridView ID="gvStudentChats" runat="server" AutoGenerateColumns="False" CssClass="table" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" ForeColor="Black" GridLines="Horizontal" CellSpacing="0" CellPadding="10" Font-Size="Small" AllowPaging="true">
        <Columns>
            ...
            <asp:TemplateField HeaderText="View Chat">
                <ItemTemplate>
                    <asp:Button ID="btnView" runat="server" Text="View" CommandArgument='<%# Eval("ChatID") %>' OnClick="btnView_Click" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
            ...
            <asp:Panel ID="pnlChatPopup" runat="server" Visible="false" CssClass="chat-popup" Style="padding: 15px; margin-top: 20px; border-radius: 10px; box-shadow: 0px 0px 8px 0px;">
                <div>
                    <div class="d-flex align-items-top flex-wrap">
                        <div class="me-2">
                            <span class="avatar">
                                <img src="../SiteImages/student.jpg" alt="" class="avatar">
                            </span>
                        </div>
                        <div class="flex-fill">
                            <p class="fw-semibold mb-0"><asp:Label ID="lblstudentname" runat="server" Text="Student Name"></asp:Label></p>
                            <span class="text-muted fs-12"><asp:Label ID="lblstudentclass" runat="server"></asp:Label></span>
                        </div>
