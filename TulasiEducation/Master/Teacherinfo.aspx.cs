...
namespace TulasiEducation.Master
{
    public partial class Teacherinfo : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = new DataTable();
            dt = objdbfunctions.Fun_Teacher(0, null, null, DateTime.Now.ToString(), null, null, null, null, null, null, 0, null, null, null,0, "Get");
            if (dt.Rows.Count > 0)
            {
        ...
        {
            dt = objdbfunctions.Fun_Teacher(0, null, null, DateTime.Now.ToString(), txt_search.Text.ToString(), null, txt_search.Text, null, null, null, 0, null, null, null,0, "GetByPhone");
            if (dt.Rows.Count > 0)
            {
                grv_list.DataSource = dt;
                grv_list.DataBind();
